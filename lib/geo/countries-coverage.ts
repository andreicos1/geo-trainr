...
export const COUNTRY_COVERAGE: CountryCoverage[] = [
  ...
  // --- Africa ---
  { code: "710", name: "South Africa", continent: "AF", bboxes: [[-34.8, 17, -25.7, 32.9]] },
  ...
  { code: "072", name: "Botswana", continent: "AF", bboxes: [[-25, 23, -19, 27.9]] },
  { code: "404", name: "Kenya", continent: "AF", bboxes: [[-1.5, 36, 0.5, 38]] }, // Nairobi region roads
  { code: "686", name: "Senegal", continent: "AF", bboxes: [[13.5, -17.5, 15.7, -12.5]] },
  { code: "288", name: "Ghana", continent: "AF", bboxes: [[5, -2.5, 7.5, 0.5]] },
  { code: "566", name: "Nigeria", continent: "AF", bboxes: [[6, 3, 9.2, 8.5]] }, // Lagos/Abuja corridor
  {
    code: "516",
    name: "Namibia",
    continent: "AF",
  ...
  { code: "646", name: "Rwanda", continent: "AF", bboxes: [[-2.1, 29.9, -1.85, 30.2]] }, // Kigali
  { code: "800", name: "Uganda", continent: "AF", bboxes: [[0.2, 32.45, 0.45, 32.7]] }, // Kampala
  { code: "788", name: "Tunisia", continent: "AF", bboxes: [[33.5, 8, 37.5, 11.6]] }, // North-south highway corridor

  // --- North America ---
  { code: "840", name: "United States", continent: "NA", bboxes: [[25, -124.7, 49, -67]] },
  { code: "124", name: "Canada", continent: "NA", bboxes: [[42, -123, 60, -53]] },
  { code: "484", name: "Mexico", continent: "NA", bboxes: [[16, -105, 26, -97]] },
  ...
  { code: "032", name: "Argentina", continent: "SA", bboxes: [[-38, -68, -27, -57]] },
  { code: "152", name: "Chile", continent: "SA", bboxes: [[-41, -73.5, -30, -70]] },
  { code: "858", name: "Uruguay", continent: "SA", bboxes: [[-34.9, -58.4, -30.1, -53.1]] },
  { code: "170", name: "Colombia", continent: "SA", bboxes: [[3.5, -76.5, 7, -73.5]] }, // Bogota/Medellin corridor
  { code: "604", name: "Peru", continent: "SA", bboxes: [[-13, -77.5, -11, -76]] }, // Lima region
  { code: "218", name: "Ecuador", continent: "SA", bboxes: [[-5, -81.1, 1.5, -75.2]] },
  { code: "600", name: "Paraguay", continent: "SA", bboxes: [[-27.6, -62.7, -19.3, -54.3]] },
  { code: "068", name: "Bolivia", continent: "SA", bboxes: [[-16.65, -68.25, -16.35, -68]] }, // La Paz region
